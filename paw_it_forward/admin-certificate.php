<?php
    ...
    if (isset($_GET['donationId'])) {
        ...
        $updateQuery = "UPDATE Donation SET VerificationStatus = 'Approved' WHERE DonationId = '$donationId'";
        mysqli_query($conn, $updateQuery);
        
        // Remove the donation from the admin page
        $deleteQuery = "DELETE FROM Donation WHERE DonationId = '$donationId'";
        mysqli_query($conn, $deleteQuery);
        
        header('Location: admin-certificate.php');
        exit;
    }
?>
