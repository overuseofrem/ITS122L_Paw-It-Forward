...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 09, 2025 at 08:55 PM
...
(4, 1, 1, 1, 'database/uploads/donation_proof/donation-alyanna-67cdbe96eb6b7.jpg', 'Rejected', '2025-03-09 16:15:18');
...
(3, 1, 3, 20000.00, 1000.00, 'Approved'),
...
--
ALTER TABLE `certificate`
  MODIFY `CertificateID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `donation`
  MODIFY `DonationID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
